...
Usage:
  ...
  ac3cli decode        <in.ac3|in.ec3> <out.wav> [objects_dir] [adm_out] (AC-3 or E-AC-3; bsid decides. objects_dir (E-AC-3 Atmos only): export each JOC-reconstructed object as its own object_NN.wav there. adm_out (E-AC-3 dynamic-object Atmos only, needs -DAC3FORGE_BUILD_ADM=ON): write a Dolby Atmos Master ADM Profile BW64 there, roadmap IM2)
  ...
  ac3cli qc            <in.ac3|in.ec3> [preset=<name>|all] [layout=bed|rendered] [objects=<51|71|512|514|714>] (bitstream-aware loudness QC: measured loudness vs. embedded dialnorm/compr, optional preset gate, optional BS.1770-5 Annex 4 object re-render)
