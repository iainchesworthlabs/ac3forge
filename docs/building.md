...
[`tools/checks/coverage_report.sh`](../tools/checks/coverage_report.sh) for their floors, which
start deliberately low pending a first real calibration run.
