...
- **Built, run under emulation.** The bare-metal profile decodes correctly on QEMU, and so does
  the ESP32-S3 build. Correct output; nothing about timing on real silicon, which for the
  ESP32-S3 is the open question.
