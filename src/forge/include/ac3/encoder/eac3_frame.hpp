...
struct FrameConfig {
 ...
 // measured its way to on average (legacy item EQ13; AC-3's own
 ...
 // and untangling that was scoped out too; see closed-loop encoder search. Silently
...
// (legacy item PF6; ac3/latency.hpp documents the four terms).
//
...
class AC3FORGE_EXPORT FrameEncoder {
 ...
 // legacy item PF6 - see ac3/latency.hpp for what each term means and
...
class AC3FORGE_EXPORT AccessUnitEncoder {
 ...
 // legacy item PF6. Every substream of an access unit codes the same 1536
