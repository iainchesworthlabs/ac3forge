...
struct MixLevels {
    ...
    // one. E-AC-3's mixmdate and, for a bsid-6 AC-3 stream, Annex D's xbsi1
    // are what mix_levels() reads it from - AC-3's plain bsi cmixlev/
    // surmixlev say nothing about it - and a reserved '11' is reported here
    // as kReserved, as sent.
