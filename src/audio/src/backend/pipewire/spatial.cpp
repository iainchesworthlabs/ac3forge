...
// The PipeWire spatial backend: there isn't one. ISpatialAudioObjectRenderStream
// is a Windows API with no PipeWire equivalent - unlike monitor.cpp/passthrough.cpp,
