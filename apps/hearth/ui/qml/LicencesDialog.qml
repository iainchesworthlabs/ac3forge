    ...
    contentItem: ColumnLayout {
        ...
        ScrollView {
            ...
            TextArea {
                ...
                color: Theme.text
                background: null
                text: HearthController.licenceNotices
            }
        }
        RowLayout {
            Layout.topMargin: Theme.space3
            Item { Layout.fillWidth: true }
            Button { id: closeButton; objectName: "licencesCloseButton"; text: qsTr("Close"); highlighted: true; onClicked: root.close() }
        }
    }
}
