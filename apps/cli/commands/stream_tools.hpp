...
// The stream tools (legacy item DC9): commands that operate on an ALREADY-encoded
...
// command re-reading and re-scanning its own file. 'play' (legacy item UX9)
...
// MonitorSink ('play', the play/monitor follow mode) - and returns false to abort, already
