 ...
 *meta.capture2);
 ...
 // positions=: a real live object-position source (legacy item UX4) instead
 ...
 // The parallel downmix leg (legacy item IO9, mirroring the GUI's
 ...
 *type == ac3::iec61937::BurstDataType::kEac3 ? "Dolby Digital Plus"
 ...
 // streams rather than accumulating (legacy item IO9). A close() complaint is
