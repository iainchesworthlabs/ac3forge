...
void print_usage() {
    ...
    std::println("       layout=rendered meters the whole assembled program - a dependent");
    std::println("       substream's height, wide and rear channels included - through");
    std::println("       BS.1770-5 Annex 3's extended algorithm, instead of the default");
    std::println("       layout=bed's Table 5.8 bed through Annex 1's basic one.");
}
