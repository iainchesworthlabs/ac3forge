    ...
    Platform.SystemTrayIcon {
        ...
        menu: Platform.Menu {
            ...
            Platform.Menu {
                ...
                // build with no object renderer a person could choose from
                // here exactly what the window would not let them choose two
                // clicks away - and the policy would then fall back on every
                // endpoint without saying why.
