...
Flickable {
    ...
    ColumnLayout {
        ...
        Text {
            Layout.fillWidth: true
            text: qsTr("Every application plays into the system default output. With the silent device as that default, nothing is heard from it; this app taps each application there, places it in the room, encodes the scene, and sends the result to the endpoint the pin and the hardware choose. That endpoint is the only thing you hear.")
                ...
                ColumnLayout {
                    ...
                    ComboBox {
                        ...
                        model: [
                            ...
                            { label: qsTr("Headphones (spatial)"), value: "headphones" },
