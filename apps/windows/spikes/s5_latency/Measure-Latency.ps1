...
# bypassed. For each, starts the demo's runner (ac3windemo) on the given
# null sink, waits for it to settle, runs s5_latency against its pid, and
# collects the RESULT line.
#
#   .\Measure-Latency.ps1 -Runner <path\ac3windemo.exe> -Spike <path\s5_latency.exe> [-NullSink FxSound] [-Seconds 20]
#
