...
// --- the integer-exact PCM path (TrueHD/MLP's WAV I/O) ---------------------
//
// Merged from the TrueHD branch's tests/test_wav.cpp: the lossless codec's
// obligation is exactness, so these cover read_wav_pcm/write_wav_pcm at both
// supported widths plus their rejection paths.
