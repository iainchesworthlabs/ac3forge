...
// legacy item C2: `ac3cli qc` - decode a stream, measure it with the real
...
// legacy item C2's own explicit ask: a case where the embedded dialnorm and the
...
// container I/O's remaining half: decode/qc/levels (play/monitor share the same
