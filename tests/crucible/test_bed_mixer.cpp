...
TEST_CASE("stereo folds to the average and lands on L and R of the bed", "[crucible]") {
...
TEST_CASE("bed contributions accumulate and take the gain", "[crucible]") {
...
TEST_CASE("7.1 maps by channel, folds the rear pairs at -3 dB and drops the LFE", "[crucible]") {
...
TEST_CASE("5.1 maps by channel and drops the LFE", "[crucible]") {
...
TEST_CASE("a mono fold of a fully driven surround signal does not clip", "[crucible]") {
...
TEST_CASE("an unknown channel count is spread front left and right, never dropped", "[crucible]") {
...
TEST_CASE("a short input leaves the tail of the output silent", "[crucible]") {
