...
PYBIND11_MODULE(_ac3forge, m) {
 ...
 // ac3::describe(DiagnosticEvent), legacy item AP11's ac3/decoder/diagnostics.hpp) -
 ...
 .def(py::init([](py::kwargs kwargs) {
 // trace/eac3_trace (legacy item AP12) hold pointers into caller-owned
