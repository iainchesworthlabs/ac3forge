...
std::string frame_error_name(ac3::FrameError e) {
    switch (e) {
        case ac3::FrameError::kInvalidBitrate:
            return "kInvalidBitrate";
        case ac3::FrameError::kInvalidDialnorm:
            return "kInvalidDialnorm";
        case ac3::FrameError::kInvalidSubstream:
            return "kInvalidSubstream";
        case ac3::FrameError::kInvalidChannelMap:
            return "kInvalidChannelMap";
        case ac3::FrameError::kTooManyChannels:
            return "kTooManyChannels";
        case ac3::FrameError::kInvalidMixLevel:
            return "kInvalidMixLevel";
        case ac3::FrameError::kInvalidBsi:
            return "kInvalidBsi";
        case ac3::FrameError::kInvalidObjectAudio:
            return "kInvalidObjectAudio";
    }
    return "unknown";
}
...
struct EncodeFailure : std::runtime_error {
    ...
    explicit EncodeFailure(ac3::FrameError c)
        : std::runtime_error("ac3forge encode failed: FrameError." + frame_error_name(c)),
          code(c) {}
};
