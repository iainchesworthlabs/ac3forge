...
already exist; clang-tidy, PREfast and CodeQL run nightly against `main` rather than per pull
request. What remains is mostly what the tree names itself.
...
See `docs/building.md`'s Gaps section, and `docs/platforms/esp32.md` for the ESP32-S3 target that
motivated it.
</details>
