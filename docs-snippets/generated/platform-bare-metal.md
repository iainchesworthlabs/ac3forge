...
| Hearth Sendspin sink | **Unavailable** | **Source**<br>confirmed on hardware<br>two-board group run; no DAC connected | **Unavailable** | **Limited**<br>confirmed on hardware<br>stereo only; two-board group with an S3, no underruns; no Sendspin CI | **Unavailable**<br>not yet a media_player or speaker |
