...
[docs/platforms/android.md](docs/platforms/android.md). And **AC3Forge Crucible**, a Windows app
...
apps/crucible/  AC3Forge Crucible: the engine, the ac3crucible-run runner and the
                ac3crucible window; the Ac3ForgeNullSink driver (MS-PL, separately licensed); its
...
| [docs/platforms/windows-demo.md](docs/platforms/windows-demo.md) | AC3Forge Crucible: the PC's applications as Atmos objects, design, phase record and what is verified |
