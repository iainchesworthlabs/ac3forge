...
tools/          Python: table/fixture generators (generators/), correctness checks
                and the gold-reference gate (checks/), independent reference
                implementations (references/), CI-only orchestration - trend
                appenders, the codec matrix, the FFmpeg quality race (ci/)
