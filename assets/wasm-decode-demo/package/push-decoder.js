 ...
 */
export function scanStream(module, bytes) {
...
const DEFAULT_FOLD_OPTIONS = { target: DownmixTarget.AsCoded };
export class PushDecoder {
    #native;
    #closed = false;
    constructor(module, fold = DEFAULT_FOLD_OPTIONS) {
    ...
    fold(index) {
        if (index >= this.#native.foldChannelCount())
            return null;
        return this.#native.foldPcm(index);
    }
    get foldChannelCount() {
    ...
    flushedChannel(flushIndex, channel) {
...
//# sourceMappingURL=push-decoder.js.map