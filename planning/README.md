...
| [esp32-device-ui.md](esp32-device-ui.md) | The player's web UI: a page the board serves from flash beside the REST API, and calls it | Built 2026-09-11; tested on the host and under QEMU, and its requests measured on a board |
