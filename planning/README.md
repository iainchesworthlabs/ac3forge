...
| [esp32-714-realtime.md](esp32-714-realtime.md) | 7.1.4 E-AC-3 in real time on the player: a stage-by-stage profile of the frame on a board, the options with what each saves, and the decisions | Profiled on a board 2026-09-11, and the first decisions measured there; decisions 12 to 15 await the user |
