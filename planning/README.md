...
| [esp32-ota.md](esp32-ota.md) | Firmware updates over the network for `hearth_sink` boards (S3, C6, P4): A/B slots, rollback, signed images, flash mode | Proposed 2026-09-24; nothing built |
