...
| [esp32-device-ui.md](esp32-device-ui.md) | The player's web UI: a page the board serves from flash beside the REST API, and calls it | Built and tested on the host and under QEMU 2026-09-11; not run on a board |
